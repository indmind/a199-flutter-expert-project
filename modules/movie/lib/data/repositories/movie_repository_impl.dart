...
extension EntityMapper on WatchlistTable {
  static WatchlistTable fromMovieEntity(MovieDetail movie) => WatchlistTable(
        id: movie.id,
        title: movie.title,
...
class MovieRepositoryImpl implements MovieRepository {
  ...
  Future<Either<Failure, String>> saveWatchlist(MovieDetail movie) async {
    try {
      final result = await localDataSource
          .insertWatchlist(EntityMapper.fromMovieEntity(movie));
      return Right(result);
  ...
  Future<Either<Failure, String>> removeWatchlist(MovieDetail movie) async {
    try {
      final result = await localDataSource
          .removeWatchlist(EntityMapper.fromMovieEntity(movie));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    }
